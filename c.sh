...
do
	...
	#echo  'CUDA_VISIBLE_DEVICES="0" python ptest.py  --test_days 120 --num_workers 120 --checkpoint="/home/jz/tmp/PPO_TradingEnv_0_2020-08-12_16-23-06q9ortuzz/checkpoint_'$i'0/checkpoint-'$i'0"    > logs8.'$i'0'
	echo 'echo `date`'
done
